...
@section('title', 'Company Edit Super Stokist')
@section('content')
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Total Policy">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Per Policy Rate">
                                </div>
                                <div class="col-sm-6">
