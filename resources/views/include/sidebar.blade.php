            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                @if($roleName == 1)
                {
                    ...
                    <div class="nav-item {{ ($segment1 == 'company-details') ? 'active' : '' }}">
                        <a href="{{route('company-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Company')}}</span></a>
                    </div>
    
                    <div class="nav-item {{ ($segment1 == 'super-stokist-details') ? 'active' : '' }}">
                        <a href="{{route('super-stokist-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Super Stokist')}}</span></a>
                    </div>
    
                    <div class="nav-item {{ ($segment1 == 'distributor-details') ? 'active' : '' }}">
                        <a href="{{route('distributor-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Distributor')}}</span></a>
                    </div>
    
                    <div class="nav-item {{ ($segment1 == 'employee-details') ? 'active' : '' }}">
                        <a href="{{route('employee-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Employee')}}</span></a>
                    </div>
    
                    <div class="nav-item {{ ($segment1 == 'retailer-details') ? 'active' : '' }}">
                        <a href="{{route('retailer-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Retailer')}}</span></a>
                    </div>

                    <div class="nav-item {{ ($segment1 == 'promoter-details') ? 'active' : '' }}">
                        <a href="{{route('promoter-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Promoter')}}</span></a>
                    </div>
                    ...
                    <div class="nav-item {{ ($segment1 == 'manage-role') ? 'active' : '' }}">
                        <a href="{{url('manage-role')}}"><i class="ik ik-user"></i><span>{{ __('Manage Role')}}</span></a>
                    </div>
                    ...
                    <div class="nav-item {{ ($segment1 == 'manage-packages') ? 'active' : '' }}">
                        <a href="{{url('manage-packages')}}"><i class="ik ik-user"></i><span>{{ __('Manage Packages')}}</span></a>
                    </div>
                    ...
                    <div class="nav-item {{ ($segment1 == 'customer-details') ? 'active' : '' }}">
                        <a href="{{route('customer-details')}}"><i class="ik ik-user"></i><span>{{ __('Manage Customer')}}</span></a>
                    </div>
                ...
                @elseif($roleName == 2)
                {
                    ...
                    <div class="nav-item {{ ($segment1 == 'manage-enterprise') ? 'active' : '' }}">
                        <a href="{{url('manage-enterprise')}}"><i class="ik ik-user"></i><span>{{ __('Manage Enterprise')}}</span></a>
                    </div>
